...
def get_Connectome_raw(outdir, selected_neuronID, indir='/data2/liaominghui/project/HemiBrain/data/source_data/data_for_wangguojia'):
...
def get_Connectome_raw_WithoutNone(outdir, selected_neuronID, indir='/data2/liaominghui/project/HemiBrain/data/source_data/data_for_wangguojia'):
    if os.path.exists(osp.join(outdir, 'edge_index.npy')):
        return np.load(osp.join(outdir, 'edge_index.npy')),\
               np.load(osp.join(outdir, 'edge_attr.npy')),\
               np.load(osp.join(outdir, 'y.npy'))
...
class HemiConnectome(InMemoryDataset):
    ...
    def process_set(self):
        ...
        skeleton_raw_path = f'/data2/liaominghui/project/HemiBrain/data/source_data/coarsen_skeleton_more{density}/raw'
...
if __name__ == '__main__':
    for density in [3, 5, 20, 50, 100, 200, 500]:
