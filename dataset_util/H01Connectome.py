...
import torch
import numpy as np
from dataset_util.HemiSkeleton import HemiSkeleton
from model import PointNetSkeleton
import sys
...
def get_label():
    ...
    if os.path.exists('/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/y.npy'):
        return np.load('/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/y.npy')
    ...
    for y, categoroy in enumerate(categories):
        for neuron in glob.glob(f'{skeleton_raw_path}/{categoroy}/*'):
            label.append(y)
    np.save('/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/y.npy', label)
...
def get_edge_raw():
    path = '/data2/liaominghui/project/HemiBrain/data'
...
def get_edge_attr_raw():
    get_edge_raw()
    if os.path.exists(f'/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/edge_index.npy'):
        return  np.load('/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/edge_index.npy'),\
                np.load('/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/edge_attr.npy')
    edge = glob.glob(f'/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/*')
    edge_index = np.load(f'{edge[0]}').astype(int)
    for fracton_path in edge[1:]:
        if fracton_path == '/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/edge_attr.npy':
            continue
    ...
    for value in edge_attr.values():
        attr.append(value)
    attr = np.array(attr)
    np.save('/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/edge_index.npy', out_edge)
    np.save('/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/edge_attr.npy', attr)
    return np.load('/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/edge_index.npy'), \
           np.load('/data2/liaominghui/project/HemiBrain/data/h01_c3/H01_Connectome/raw/edge_attr.npy')
